...
strategies based on finite state automata introduced by Daniel Ashlock and Wendy
...
Defector. Thus, it's surprising that EasyGo and Fool Me Forever which are
strategies that will defect until their opponent defects, then they will cooperate
