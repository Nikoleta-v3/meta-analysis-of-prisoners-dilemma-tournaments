...
pattern. TFT does not appear in the top ranks in
 tournaments with more aggressive strategies because it is too nice. Strategies like Grudger will always
...
\item be nice, 
    ...
    \item be clever, 
    \item adapt to theenvironment (including the population of strategies).
\end{itemize}
