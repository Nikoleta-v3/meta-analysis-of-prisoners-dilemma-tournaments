...
the literature, accessible due to an open source software library
...
195 strategies, that has managed to perform well in all the tournaments it competed in.
...
environment (the population of strategies).
