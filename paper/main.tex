...
Distributions of these top ranked strategies are given by Figure~\ref{fig:r_distributions}.
\newpage
...
\begin{figure*}[!htbp]
    ...
    \begin{subfigure}{0.475\textwidth}
        ...
        \caption{$r$ distributions in standard tournaments.}\label{fig:std_results}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.475\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../images/noise_performance_subset.pdf}
